...
namespace MapGeneration
{
    public class ChildNodeGen : MonoBehaviour
    {
        ...
        public List<Vector2> GeneratePoints(Node.Type type)
        {
            ...
            for (int i = 0; i < naiborhoodSize / 2; i++)
            {
        ...
        public void GenerateNodes(Queue coords, Node.Type type, Vector3 parenScale)
        {
            ...
            foreach (Vector2 coord in coords)
            {
                ...
                {
                    offset = 1.5f;
                    // Eliminate scale magnitude on the y Axxis
                ...
                else
                {
                    ...
                    randomNode.transform.position += new Vector3(dir.x * offset * (randomNodeSize.x / 2 + naiborXZScale.x / 2), 0, dir.y * offset * (randomNodeSize.z / 2 + naiborZScale.z / 2));
